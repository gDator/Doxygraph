...
class ConfigValues
{
  public:
    ...
    bool                   CASE_SENSE_NAMES()             const                  { return m_CASE_SENSE_NAMES; }
    ...
    bool                   HTML_TIMESTAMP()               const                  { return m_HTML_TIMESTAMP; }
    ...
    bool                   FORMULA_TRANSPARENT()          const                  { return m_FORMULA_TRANSPARENT; }
    ...
    const QCString &       DOT_FONTNAME()                 const                  { return m_DOT_FONTNAME; }
    int                    DOT_FONTSIZE()                 const                  { return m_DOT_FONTSIZE; }
    ...
    bool                   DOT_TRANSPARENT()              const                  { return m_DOT_TRANSPARENT; }
    ...
    [[maybe_unused]] bool                   update_CASE_SENSE_NAMES(bool v)                       { m_CASE_SENSE_NAMES = v; return m_CASE_SENSE_NAMES; }
    ...
    [[maybe_unused]] bool                   update_HTML_TIMESTAMP(bool v)                         { m_HTML_TIMESTAMP = v; return m_HTML_TIMESTAMP; }
    ...
    [[maybe_unused]] bool                   update_FORMULA_TRANSPARENT(bool v)                    { m_FORMULA_TRANSPARENT = v; return m_FORMULA_TRANSPARENT; }
    ...
    [[maybe_unused]] bool                   update_LATEX_BATCHMODE(bool v)                        { m_LATEX_BATCHMODE = v; return m_LATEX_BATCHMODE; }
    ...
    [[maybe_unused]] bool                   update_LATEX_TIMESTAMP(bool v)                        { m_LATEX_TIMESTAMP = v; return m_LATEX_TIMESTAMP; }
    ...
    [[maybe_unused]] const QCString &       update_DOT_FONTNAME(const QCString & v)               { m_DOT_FONTNAME = v; return m_DOT_FONTNAME; }
    [[maybe_unused]] int                    update_DOT_FONTSIZE(int v)                            { m_DOT_FONTSIZE = v; return m_DOT_FONTSIZE; }
    ...
    [[maybe_unused]] bool                   update_DOT_TRANSPARENT(bool v)                        { m_DOT_TRANSPARENT = v; return m_DOT_TRANSPARENT; }
    ...
    struct Info
    {
      ...
      Info(Type t,QCString     ConfigValues::*s, Enum2BoolMap boolMap = {}) : type(t), value(s), m_boolMap(boolMap) {}
